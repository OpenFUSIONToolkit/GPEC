...
include("special.jl")
include("grid_mod.jl")
include(joinpath(@__DIR__, "..", "Splines", "Splines.jl"))
...
function CSplineType()
    xs = [0.0, 1.0]
    fs = zeros(Float64, 2, 1)
    return SplinesMod.CubicSpline(xs, fs; bctype="not-a-knot")
end
include("pitch_integration.jl")
include("energy_integration.jl")
include("dcon_interface.jl")
include("inputs.jl")
