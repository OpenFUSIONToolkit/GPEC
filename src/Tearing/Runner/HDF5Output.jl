...
const TEARING_H5_ANNOTATIONS = [
    ...
    "PerSurface/D_geo" =>
        (; long_name="Connor et al. 2015 Eq. 59 toroidal critical-Δ geometric factor in the r_s reference or the dgeo_val override (0 without ResistGeometry)", dims=("surface",)),
