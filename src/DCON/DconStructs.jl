...
@kwdef mutable struct FourFitVars
    ...
    # Kinetic spline matrices (used for setting up the PENRC equilibrium in main.jl if kin_flag=true)
    # Needed to create w_i^T*w_j coefficient matrices
    smats::Spl.CubicSpline{ComplexF64} = Spl.empty_CubicSpline(ComplexF64)
    tmats::Spl.CubicSpline{ComplexF64} = Spl.empty_CubicSpline(ComplexF64)
    xmats::Spl.CubicSpline{ComplexF64} = Spl.empty_CubicSpline(ComplexF64)
    ymats::Spl.CubicSpline{ComplexF64} = Spl.empty_CubicSpline(ComplexF64)
    zmats::Spl.CubicSpline{ComplexF64} = Spl.empty_CubicSpline(ComplexF64)
