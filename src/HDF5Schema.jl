...
const MAIN_H5_ANNOTATIONS = [
    ...
    "Equilibrium/psi_edge" => (; long_name="normalized poloidal flux at the outermost formed flux surface (the requested psihigh, clamped to the outermost closed surface)"),
