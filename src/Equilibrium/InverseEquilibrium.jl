...
function equilibrium_solver(input::InverseRunInput)
    ...
    rzphi = Spl.BicubicSpline(copy(sq_xs), collect(0:mtheta) ./ mtheta, rzphi_fs,
        :extrap, Spl.PeriodicBC())
    eqfun = Spl.BicubicSpline(copy(sq_xs), collect(0:mtheta) ./ mtheta, eqfun_fs,
        :extrap, Spl.PeriodicBC())
    ...
    for ipsi in 0:mpsi
        ...
        for itheta in 0:mtheta
            ...
            f_rz_in, fx_rz_in, fy_rz_in = Spl.deriv1!(rz_spline, psifac, theta)
            f_sq_in = sq_in(psifac)
