...
function _compute_rzphi_modes(
    ...
    for ipsi in 1:npsi
        ...
        for itheta in 1:mtheta
            ...
            dr2_dpsi    = equil.rzphi_rsquared(pt; deriv=Val((1, 0)), hint=hint)
            dr2_dtheta  = equil.rzphi_rsquared(pt; deriv=Val((0, 1)), hint=hint)
            doff_dpsi   = equil.rzphi_offset(pt; deriv=Val((1, 0)), hint=hint)
            doff_dtheta = equil.rzphi_offset(pt; deriv=Val((0, 1)), hint=hint)
