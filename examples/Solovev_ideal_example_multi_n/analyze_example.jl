...
p_modes_n1 = JPEC.Analysis.ForceFreeStates.plot_mode_displacement(h5path_n1; modes=1:5)
p_modes_n2 = JPEC.Analysis.ForceFreeStates.plot_mode_displacement(h5path_n2; modes=1:5)
