...
# Perturbed equilibrium plots (requires PE module run with forcing.dat)
p_resfield    = Analysis.PerturbedEquilibrium.plot_resonant_field(h5path)
p_pe_summary  = Analysis.PerturbedEquilibrium.plot_perturbed_equilibrium_summary(h5path)
p_spectrogram = Analysis.PerturbedEquilibrium.plot_mode_spectrogram(h5path; component=:xi_psi)
