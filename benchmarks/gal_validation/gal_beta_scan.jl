...
# Reuses examples/LAR_beta_scan/gpec.toml. Writes gal_beta_scan_results.h5 + CSV next to this script.
using Pkg
...
# Save
out_h5 = joinpath(@__DIR__, "gal_beta_scan_results.h5")
...
open(joinpath(@__DIR__, "gal_beta_scan_results.csv"), "w") do io
...
@info "Saved gal_beta_scan_results.h5 and .csv to $(@__DIR__) ($(length(results)) points)"
println("DONE")
