#!/usr/bin/env julia
"""
    benchmark_diiid_kinetic_dcon.jl
...
Usage:
    julia --project=. benchmarks/benchmark_diiid_kinetic_dcon.jl [fortran_dir]
...
function build_benchmark_tomldir(eq_file::String, kin_file::String)
    ...
    open(joinpath(tmpdir, "gpec.toml"), "w") do io
        println(io, """
        # Auto-generated by benchmark_diiid_kinetic_dcon.jl — do not edit.
