...
@testset "ODE Tests" begin
    @testset "ode_fixup!" begin
        ...
        u_orig = copy(odet.u)
        JPEC.DCON.ode_fixup!(odet, intr, false)
    ...
    @testset "ode_unorm!" begin
        ...
        JPEC.DCON.ode_unorm!(odet, ctrl, intr, false)
        ...
        odet.u[:, 1, 1] .= 0
        odet.new = true
        @test_throws ErrorException JPEC.DCON.ode_unorm!(odet, ctrl, intr, false)
        ...
        odet.u[:, 1, 1] .= [1, 0]
        odet.u[:, 2, 1] .= [1, 0]
        JPEC.DCON.ode_unorm!(odet, ctrl, intr, true)
