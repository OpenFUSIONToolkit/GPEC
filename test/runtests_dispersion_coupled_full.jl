@testset "Dispersion 4m×4m full Pletzer-Dewar coupled determinant (CoupledFullMatch)" begin
    ...
    struct _LinearInnerF <: InnerLayerModel
        a_t::ComplexF64
        b_t::ComplexF64   # tearing: Δ_t(Q) = a_t + b_t·Q
        a_i::ComplexF64
        b_i::ComplexF64   # interchange: Δ_i(Q) = a_i + b_i·Q
    end
    ...
    @testset "1-surface 4×4 det matches hand computation" begin
        ...
        mc = multi_surface_coupling_full([sc], dp_raw)
    ...
    @testset "Static (rotation=0) delta1, delta2 assembly" begin
        # Replicate the Pletzer-Dewar match assembly by hand for msing=2 and
        # synthetic inner values; confirm the module agrees.
        dp_raw = ComplexF64[
            10.0 0.1 0.2 0.3;
            0.1 11.0 0.4 0.5;
            0.2 0.4 -5.0 0.6;
    ...
    @testset "SurfaceCoupling scale multiplies both inner channels" begin
        ...
        mc1 = multi_surface_coupling_full([sc_unit], dp_raw)
        mc2 = multi_surface_coupling_full([sc_x2], dp_raw)
    ...
    @testset "msing_max truncation" begin
        ...
        mc1 = multi_surface_coupling_full([sc1, sc2], dp_raw; msing_max=1)
        det1 = mc1(0 + 0im)
        ...
        mcfull = multi_surface_coupling_full([sc1, sc2], dp_raw; msing_max=2)
    ...
    @testset "inner_kwargs pass-through" begin
        ...
        mc_native = multi_surface_coupling_full([sc], dp_raw)
        mc_tuned = multi_surface_coupling_full([sc], dp_raw;
