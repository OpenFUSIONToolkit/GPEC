...
@testset "error fields" begin
    ...
    @testset "coil-forced Solovev run: identities, output, and post-hoc entry point" begin
        ...
        mktempdir() do dir
            ...
            ctx = EF.PostHocContext(ffs.equil, rc, cfg, ffs.psilim, sens.b_t0)
            ...
            @test_logs (:warn, r"points per period") match_mode = :any EF.PostHocContext(ffs.equil, rc, coarse_cfg, ffs.psilim, sens.b_t0)
